...
import kroki from './assets2/kroki.png';
...
function App() {
  ...
  const handleMouseDown = (event) => {
    ...
    else if (tool === elementType.line || tool === elementType.rectangle || tool === elementType.pencil || tool === elementType.text) {
  ...
  const [mousekoord, setMouseKoord] = useState({})
  console.log(mousekoord)
    ...
    <div>
      <div style={{ position: "fixed" }}>
        <input
          ...
          style={{ display: "none" }}
        />
        <label htmlFor="selection" style={{ display: "none" }}>Selection</label>
        ...
        <input
          ...
          style={{ display: "none" }}
        />
        <label htmlFor="rectangle" style={{ display: "none" }} >Rectangle</label>
      ...
      <div style={{ position: "fixed", top: 0, right: 0, padding: "10px", display: "none" }}>
        <button style={{ marginRight: "5px" }} onClick={() => undo()}>Undo (Ctrl + Z)</button>
        <button style={{ marginRight: "5px" }} onClick={() => redo()}>Redo (Ctrl + Y)</button>
        <button style={{ backgroundColor: "red", color: "white" }} onClick={clearScreen}>Clear Screen</button>
      </div>
